...
function main() {
    ...
    function init(appContext: AppContext, nLines: number, quad: boolean, prev?: string) {
    ...
    function draw(appContext: AppContext) {
    ...
    // init(appContext, 7, canvas.className == 'quadratic', prev);
    init(appContext, 7, false, prev);
}
